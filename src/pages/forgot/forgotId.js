...
const $emailInput = document.querySelector("input[name='forgot-id-user-email']");
const $emailSelect = document.querySelector("select[name='forgot-id-user-email']");
...
//   if ($emailSelect.value === "email-typing") {
//     $emailInput.value = "";
//     $emailInput.placeholder = 'Ex) userEmail@naver.com';
//     $emailInput.focus();
//     $emailSelect.style.display = "none";
//     $emailInput.style.width = "86%";
//   }
